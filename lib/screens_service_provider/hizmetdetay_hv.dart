...
class HizmetDetayHV extends StatefulWidget {
  const HizmetDetayHV({Key? key}) : super(key: key);

  @override
  _HizmetDetayHVState createState() => _HizmetDetayHVState();
}

class _HizmetDetayHVState extends State<HizmetDetayHV> {
  @override
